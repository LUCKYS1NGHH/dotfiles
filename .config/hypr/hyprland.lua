...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("wl-paste --type text --watch cliphist -max-items 2000 store")
    hl.exec_cmd("wl-paste --type image --watch cliphist -max-items 2000 store")
    hl.exec_cmd("swaync")
end)
...
hl.animation({ leaf = "windows",       enabled = true, speed = 3.25, bezier = "easeOutQuint", style = "popin 40%"     })
hl.animation({ leaf = "windowsIn",     enabled = true, speed = 3.25, bezier = "easeOutQuint", style = "popin 80%"     })
hl.animation({ leaf = "windowsOut",    enabled = true, speed = 3.45, bezier = "linear",        style = "popin 85%"     })
...
hl.animation({ leaf = "layers",        enabled = true, speed = 3.50, bezier = "easeOutQuint"                   })
...
hl.animation({ leaf = "workspaces",    enabled = true, speed = 2.0,  bezier = "overshot"                       })
hl.animation({ leaf = "workspacesIn",  enabled = true, speed = 2.70, bezier = "overshot",      style = "slidefade 10%" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 2.70, bezier = "overshot",      style = "slidefade 10%" })
...
-- Binds for screenshot
hl.bind(mainMod .. " + SHIFT + F", hl.dsp.exec_cmd("hyprshot -m output --output-folder /home/xingyun/Playground/images"))
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("hyprshot -m window"))
hl.bind(mainMod .. " + SHIFT + R", hl.dsp.exec_cmd("hyprshot -m region --clipboard"))
...
hl.bind(mainMod .. " + W",         hl.dsp.exec_cmd("~/.config/rofi/wallpaper-changer/launcher.sh || pkill rofi"))
...
-- Adjust tiling window width/height
...
hl.bind(mainMod .. " + J", hl.dsp.window.swap( { direction = "r"} ))
...
hl.window_rule({
  name = "utilities",
  match = {
    class = "thunar|vlc|mpv|swayimg|fcitx5-config-qt"
  },
...
hl.window_rule({
  ...
  match = {
    class = "brave-browser",
    title = "Sign in|Signin|OAuth|Connect|Authorize|Pop-up|open"
  },
